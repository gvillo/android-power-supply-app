...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    private static Preference.OnPreferenceChangeListener sBindPreferenceSummaryToValueListener = new Preference.OnPreferenceChangeListener() {
        ...
        public boolean onPreferenceChange(Preference preference, Object value) {
            ...
            if (preference instanceof ListPreference) {
                ...
                if (preference.getKey().equalsIgnoreCase("automatic_updates")) {
                    if (((SwitchPreference) preference).isChecked()) {
                        PowerSupplyAlarmReceiver receiver = new PowerSupplyAlarmReceiver();
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            // guidelines.
            bindPreferenceSummaryToValue(findPreference("general_router_url"));
            bindPreferenceSummaryToValue(findPreference("general_username"));
            bindPreferenceSummaryToValue(findPreference("general_password"));
            bindPreferenceSummaryToValue(findPreference("general_read_timeout"));
            bindPreferenceSummaryToValue(findPreference("general_connect_timeout"));
        }
    ...
    public static class DataSyncPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            // updated to reflect the new value, per the Android Design
            // guidelines.
            bindPreferenceSummaryToValue(findPreference("automatic_updates"), true);
